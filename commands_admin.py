...
def commands_admin(client, tree):
    ...
    @tree.command(name="git_list", description="Lists open issues/pull requests on the Antistasi Ultimate github.", guild=guild_id)
    ...
    @tree.command(name="git_branch_update", description="Updates a branch on the Antistasi Ultimate github.", guild=guild_id)
    @app_commands.check(is_admin)
    ...
    @tree.command(name="git_pull_merge", description="Merges a pull request on the Antistasi Ultimate github.", guild=guild_id)
    @app_commands.check(is_admin)
    ...
    @tree.command(name="git_pull_create", description="Creates a pull request on the Antistasi Ultimate github.", guild=guild_id)
    @app_commands.check(is_admin)
    ...
    @tree.command(name="git_issue_create", description="Creates an issue on the Antistasi Ultimate github.", guild=guild_id)
    @app_commands.check(is_admin)
