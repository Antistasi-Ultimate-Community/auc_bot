...
def return_pull(pull_index=-1):
    fallback_url = "https://github.com/Antistasi-Ultimate-Community/A3-Antistasi-Ultimate/issues/#"
    ...
    if (pull_index == -1 or pull_index == "" or pull_index is None):
        ...
        url = return_url(url=f"https://github.com/Antistasi-Ultimate-Community/A3-Antistasi-Ultimate/pull/{pull_index}", suppress=False)
        
        # If URL isn't a valid pull request, perhaps it's a valid issue
        if (url == False):
            issue_url = return_url(url=f"https://github.com/Antistasi-Ultimate-Community/A3-Antistasi-Ultimate/issues/{pull_index}", suppress=False)
